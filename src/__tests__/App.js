...
describe('testing the App component', ()=>{
  ...
  it('toggles the state of currentPage', ()=>{
  ...
  it('renders toggle components: Posts/Bot', ()=>{
    const wrapper = shallow(component);
  ...
  it('should change persona', ()=>{
    ...
    expect(wrapper.state('currentPersona')).toBe(mockEvent.target.value);
  });
});